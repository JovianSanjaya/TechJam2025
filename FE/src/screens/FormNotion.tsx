...
import { Loader2, ShieldAlert, CheckCircle2, Info, UploadCloud, FileText, Trash2, RefreshCw, Clipboard, Download } from "lucide-react"
  ...
  return (
    <TooltipProvider>
      ...
      <div className="min-h-screen bg-gray-50/30">
        {/* Header */}
        <div className="border-b border-gray-200/70 bg-white/80 backdrop-blur-sm sticky top-0 z-10">
        ...
        <div className="max-w-3xl mx-auto px-6 py-12">
          ...
          {/* Form container - Notion style */}
          <div className="bg-white border border-gray-200/70 rounded-xl shadow-sm hover:shadow-md transition-all duration-300">
            <FormRoot {...form}>
